defmodule BlockScoutWeb.Etherscan do
  ...
  @token_model %{
    ...
    fields: %{
      ...
      type: %{
        type: "token type",
        enum: ~s(["BESC-20", "ERC-721"]),
        enum_interpretation: %{"BESC-20" => "BESC-20 token standard", "ERC-721" => "ERC-721 token standard"}
      },
      cataloged: %{
        type: "boolean",
  ...
  @token_gettoken_action %{
    name: "getToken",
    description:
      "Get <a href='https://github.com/ethereum/EIPs/issues/20'>BESC-20</a> " <>
  ...
  @stats_tokensupply_action %{
    name: "tokensupply",
    description:
      "Get <a href='https://github.com/ethereum/EIPs/issues/20'>BESC-20</a> or " <>
